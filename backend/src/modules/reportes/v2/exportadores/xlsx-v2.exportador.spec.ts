...
import { XlsxV2Exportador } from './xlsx-v2.exportador';
import * as ExcelJS from 'exceljs';

describe('XlsxV2Exportador', () => {
  let exportador: XlsxV2Exportador;

  beforeEach(async () => {
    const module = await Test.createTestingModule({
      providers: [XlsxV2Exportador],
    }).compile();

    exportador = module.get<XlsxV2Exportador>(XlsxV2Exportador);
  });
