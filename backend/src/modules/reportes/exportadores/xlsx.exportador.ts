...
@Injectable()
export class XlsxExportador {
  private readonly logger = new Logger(XlsxExportador.name);
  ...
  async generar(
    ...
    this.logger.log(`Generando Excel con exceljs: ${filas.length} filas, ${columnas.length} columnas`);
